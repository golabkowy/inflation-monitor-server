...
* The original package name 'com.inflation-monitor.inflation-monitor-server' is invalid and this project uses 'com.inflationmonitor.inflationmonitorserver' instead.
